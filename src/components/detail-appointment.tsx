    ...
    <div className='bg-light-subtle' style={{ flex: '0 0 30%' }}>
      ...
      <div className='mt-3 border-bottom px-3 d-flex gap-2 w-100'>
        ...
        <div className='flex-grow-1'>
          ...
          <p className='text-theme'>{barber?.name ? barber.name : '-'}</p>
        </div>
      </div>
      ...
      <div className='mt-3 border-bottom px-3 d-flex gap-2 w-100'>
        ...
        <div className='flex-grow-1'>
          ...
          <div className='d-flex justify-content-between w-100'>
            <p className='text-theme'>{distance !== null ? `${distance} KM` : '-'}</p>
            {distance !== null && (
      ...
      <div className='mt-3 border-bottom px-3 d-flex gap-2 w-100'>
        ...
        <div className='flex-grow-1'>
          ...
          <p className='text-theme'>{date ? date : '-'}</p>
        </div>
      </div>
      ...
      <div className='mt-3 border-bottom px-3 d-flex gap-2 w-100'>
        ...
        <div className='flex-grow-1'>
          ...
          <p className='text-theme mt-3 mb-5 h4 fw-bold'>{total}K</p>
        </div>
      </div>
    </div>
  )
